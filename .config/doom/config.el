...
(setq ispell-dictionary "en_US,ja_JP")

(setq ispell-local-dictionary-alist
      '(("en_US,ja_JP" "[[:alpha:][:nonascii:]]" "[^[:alpha:][:nonascii:]]" "[']" nil ("-d" "en_US,ja_JP") nil utf-8)))
...
;;test
(remove-hook 'post-command-hook 'yay--post-command-handler)
